...
HD_PWD='E:/HardSoftCodesign/Hardsoftcodesign/RAPID/RAPID.runs/top_axi_gpio_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_axi_gpio_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_axi_gpio_0_1.tcl
